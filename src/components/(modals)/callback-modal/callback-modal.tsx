  ...
  return (
    <Modal reference={reference} onClick={onClick}>
      <div className="relative w-fit h-fit my-[70px] mx-2.5 ">
        ...
        <div className="relative mt-[30px] p-5 xl:p-10 flex flex-col justify-center max-w-[500px] w-full rounded-section-mobile lg:rounded-section-sm overflow-hidden bg-foreground">
