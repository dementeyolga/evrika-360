...
export const CallbackModal = ({
  ...
  return (
    <Modal reference={reference} onClick={onClick}>
      <div className="relative w-fit my-[70px] mx-2.5 ">
        <button
        ...
        <div className="relative mt-[30px] p-5 xl:p-10 flex flex-col max-w-[500px] max-h-[calc(100svh_-_130px)] w-full rounded-section-mobile lg:rounded-section-sm overflow-y-auto bg-foreground">
