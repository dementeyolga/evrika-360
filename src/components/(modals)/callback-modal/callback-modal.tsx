  ...
  return (
    <Modal reference={reference} onClick={onClick}>
      <div className="relative w-fit h-fit my-[70px] mx-2.5 ">
        ...
        <div className="relative mt-[30px] p-5 lg:p-10 flex flex-col lg:flex-row justify-center max-w-[600px] lg:max-w-[1000px] w-full rounded-section-mobile lg:rounded-section overflow-hidden bg-foreground">
