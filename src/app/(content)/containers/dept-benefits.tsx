...
export const DeptBenefits = () => {
  return (
    <div>
      <div className="relative mt-4 mb-[42px] lg:mb-20  lg:ml-42 pt-[90px] pb-[26px] px-5 lg:py-51px lg:pr-51px lg:pl-226px bg-sky-500 text-font-contrast rounded-section-mobile lg:rounded-section-md rounded-bl-none lg:rounded-bl-none">
        <img
